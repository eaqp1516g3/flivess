...
angular.module('Flivess').controller('messagesCtl', ['$scope', '$http', function($scope, $http) {


    $scope.hello = "Hello from Messages";


}]);

/*
angular.module('Flivess', ['ngCookies']).controller('messagesCtl', ['$scope', '$http','$cookies', function($scope, $http, $cookies) {
