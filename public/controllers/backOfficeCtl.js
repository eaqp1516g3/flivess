...
angular.module('Flivess').controller('backOfficeCtl', ['$scope', '$http', function($scope, $http) {


    $scope.hello = "Hello from BO Controller";
...
/*
angular.module('Flivess', ['ngCookies']).controller('backOfficeCtl', ['$scope', '$http', '$cookies', function($scope, $http, $cookies) {
