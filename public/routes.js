...
angular.module('Flivess', ['ngRoute', 'ngCookies','ui.bootstrap','angularModalService', 'ngAnimate', 'googlechart','angular-confirm','ngMaterial']).config(function($routeProvider) {
